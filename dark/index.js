...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["5511998346168@s.whatsapp.net","5511998346168@s.whatsapp.net","5511998346168@s.whatsapp.net"]
			const mod = [ownerNumber,"5511998346168@s.whatsapp.net","5511998346168@s.whatsapp.net","5511998346168@s.whatsapp.net"]
			const adminbotnumber = ["5511998346168@s.whatsapp.net","5511998346168@s.whatsapp.net","5511998346168@s.whatsapp.net"]
			const frendsowner = ["5511998346168@s.whatsapp.net","5511998346168@s.whatsapp.net","5511998346168@s.whatsapp.net"]
			const premium = ["5511998346168@s.whatsapp.net","5511998346168@s.whatsapp.net","5511998346168@s.whatsapp.net"]
...
if (isBanned) return reply(mess.only.benned)    
               ...
               client.reply(from, `Waalaikumsalam wr.wb${pushname}:)`)
				...
				if (!isUser) return reply(mess.only.userB)
                    ...
                    client.sendMessage('5511998346168@s.whatsapp.net', options, text, {quoted: mek})
